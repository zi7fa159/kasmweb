...
RUN sudo bash kasm_release/install.sh --offline-workspaces /tmp/kasm_release_workspace_images_amd64_1.12.0.d4fd8a.tar.gz --offline-service /tmp/kasm_release_service_images_amd64_1.12.0.d4fd8a.tar.gz
EXPOSE 443
EXPOSE 80
